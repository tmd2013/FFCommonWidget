...
@implementation NSString (FF_Extend)
...
{
    return [[self ffString_getDocumentPath] stringByAppendingPathComponent:fileName];
}
...
{
    return [[self ffString_getLibCachePath] stringByAppendingPathComponent:fileName];
}
