...
{
    return [self ff_dateGetCurrentTimes:@"yyyy-MM-dd HH:mm:ss Z"];
}


+ (NSDictionary *)ff_dateGetCurrentTimes:(NSString *)timeFormatter
{
...
+ (NSString *)ff_dateGetCurrentDateStr:(NSString *)timeFormatter
{
    return [[self ff_dateGetCurrentTimes:timeFormatter] objectForKey:ff_currentDateStr];
}
